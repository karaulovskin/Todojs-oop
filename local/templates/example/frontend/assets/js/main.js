...
var _sliders = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./js/sliders\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('.inputmask').inputmask({ mask: "+7 (999) 999-9999", greedy: false });
    ...
    _createClass(SvgUse, [{
        ...
        value: function init() {
            ...
            (function (window, document) {
                ...
                if (!App.debug) file = '/local/templates/example/frontend/assets/icons/symbol/svg/sprite.symbol.svg';

                if (window.location.href.indexOf('test.d-element') !== -1) {
                    file = './icons/symbol/svg/sprite.symbol.svg';
                }
...
var Tabs = function () {
    function Tabs() {
        ...
        this.tabLink = '[data-tabs-link]';
        this.tabLinks = '[data-tabs-links]';
        this.tab = '[data-tabs-tab]';
    ...
    _createClass(Tabs, [{
        key: 'open',
        value: function open($tabLink, $tab) {
        ...
        value: function events() {
            ...
            $(this.tabLink).on('click', function (e) {
                ...
                var tab = $(this).attr('data-tabs-link');
                self.open($(this), $(tab));
            });
        }
    }]);
...
var _fileAttach = __webpack_require__(19);

var _fileAttach2 = _interopRequireDefault(_fileAttach);

var _formValidation = __webpack_require__(20);

var _formValidation2 = _interopRequireDefault(_formValidation);

var _formSend = __webpack_require__(21);
...
var FileAttach = function () {
    function FileAttach() {
        ...
        this.attacher = '.form-file__label';
                ...
                $.ajax({
                    ...
                    success: function success(data) {
                        ...
                        if (parsedData.errors) {
                            ...
                            if (!form.attr('data-ajax-no-modal')) {
                                if (form.attr('data-ajax-modal')) {
                                    $(form.attr('data-ajax-modal')).data('modal').open();
                                } else {
                                    $('#modal-success').data('modal').open();
                                }
                            }
